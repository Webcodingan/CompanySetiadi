        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card shadow mb-4 my-5">
                    ...
                    <form action="{{ route('inputberita.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="judul_berita" type="text" name="judul_berita"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="isi" id="mytextarea" value="{{ old('isi') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="time" name="tanggal" value="{{ old('tanggal') }}"
