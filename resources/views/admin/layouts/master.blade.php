    ...
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" target="_blank">
                <img src="{{ asset('backend/assets/img/avatar.png') }}" class="navbar-brand-img h-100"
                    alt="main_logo"><b>{{ Auth::user()->name }}</b></a>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('inputberita.index') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('kontak.index') }}">
                        ...
                        <span class="nav-link-text ms-1">Contact user</span>
                    </a>
                </li>
    ...
    <main class="main-content position-relative border-radius-lg ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                ...
                <h5 class="text-white" style="font-family: arial;" id="jam"></h5>
            </div>
        </nav>
        <!-- End Navbar -->
