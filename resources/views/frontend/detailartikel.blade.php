...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl bg-primary page-header">
                <div class="container text-center">
                    <h1 class="text-white animated zoomIn mb-3">Detail Category Artikel</h1>
                </div>
            </div>
        </div>
        <!-- Navbar & Hero End -->
        ...
        <section class="inner-page">
            <div class="container">
                <div class="container text-center">
                    <h3><b>{{ $categorys->nama }}</b></h3>
                    <div class="row">
                        @foreach ($categorys->berita as $category)
                            <div class="col-sm-4">
                                <div class="card" style="width: 20rem;">
                                    <img src="{{ asset('image') }}/{{ $category->image }}" class="card-img-top"
                                        alt="{{ $category->judul_berita }}">
                                    <div class="card-body">
                                        <p class="card-text"><strong>{{ $category->judul_berita }}</strong></p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
