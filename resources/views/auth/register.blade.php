...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('frontend/img/icon.png') }}">
                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="row px-xl-5 px-sm-4 px-3">
                            ...
                            <div class="col-3 me-auto px-1">
                                <a class="btn btn-outline-light w-100" href="https://www.google.com/">
                                    <svg width="24px" height="32px" viewBox="0 0 64 64" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 mx-auto text-center mb-4 mt-2">
                    ...
                    <a href="https://www.twitter.com/" target="_blank" class="text-secondary me-xl-4 me-4">
                        <span class="text-lg fab fa-twitter"></span>
                    </a>
                    <a href="https://www.instagram.com/" target="_blank" class="text-secondary me-xl-4 me-4">
                        <span class="text-lg fab fa-instagram"></span>
                    </a>
                    <a href="https://www.pinterest.com/" target="_blank" class="text-secondary me-xl-4 me-4">
                        <span class="text-lg fab fa-pinterest"></span>
                    </a>
                    <a href="https://www.github.com/" target="_blank" class="text-secondary me-xl-4 me-4">
